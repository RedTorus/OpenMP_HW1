...
gcc -O2 tri_par4.c -o tri_par4.x -std=c99 -DN=6474 -DNUM_A=25144 -fopenmp
...
for threads in "${THREADS_LIST[@]}"; do
    ...
    cat small_IA.txt small_JA.txt | ./tri_par4.x 10
done
...
gcc -O2 tri_par4.c -o tri_par4.x -std=c99 -DN=9877 -DNUM_A=51946 -fopenmp
...
for threads in "${THREADS_LIST[@]}"; do
    ...
    cat medium_IA.txt medium_JA.txt | ./tri_par4.x 10
done
...
gcc -O2 tri_par4.c -o tri_par4.x -std=c99 -DN=22687 -DNUM_A=109410 -fopenmp
...
for threads in "${THREADS_LIST[@]}"; do
    ...
    cat large_IA.txt large_JA.txt | ./tri_par4.x 10
done
